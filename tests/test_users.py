...
sys.path.append('../testing_demo') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('waaaaaytoooooloooonggggggggggggg', 'test@example.com', 'FlaskIsAwesome')
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('test2', 'hithere', 'FlaskIsAwesome')
